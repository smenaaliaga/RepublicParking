    ...
    <div class="container-fluid">
      <div class="row">
		...
		<ul class="nav nav-sidebar">
            ...
            <li><a href="perfil">    Clientes</a></li>
            <li><a href="estadisticasGlobales">    Sucursal</a></li>
            <li class="active"><a href="config">    Gestión</a></li>
          </ul>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <?php
            if (isset($_POST['actual'])) {
               cambiarpassword($_POST['actual'],$_POST['nueva2']);
            }

            if (isset($_POST['nombre'])) {
               cambiardatos($_POST['nombre'],$_POST['email'],$_POST['public']);
            }
          ?>
